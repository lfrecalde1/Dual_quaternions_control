...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w1;
  ...
  /* #111: @16 = mac(@30,@15,@16) */
  for (i=0, rr=w16; i<1; ++i) for (j=0; j<4; ++j, ++rr) for (k=0, ss=w30+j, tt=w15+i*4; k<4; ++k) *rr += ss[k*4]**tt++;
  /* #112: @16 = (@2*@16) */
