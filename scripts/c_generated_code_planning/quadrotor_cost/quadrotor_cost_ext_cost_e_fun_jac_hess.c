...
static const casadi_int casadi_s5[9] = {0, 1, 2, 6, 7, 8, 9, 10, 11};
static const casadi_int casadi_s6[9] = {0, 1, 2, 9, 10, 11, 12, 25, 26};
static const casadi_int casadi_s7[9] = {0, 3, 6, 9, 13, 17, 21, 25, 26};
...
static const casadi_int casadi_s18[43] = {13, 13, 0, 3, 6, 9, 9, 9, 9, 13, 17, 21, 25, 26, 27, 27, 0, 1, 2, 0, 1, 2, 0, 1, 2, 6, 7, 8, 9, 6, 7, 8, 9, 6, 7, 8, 9, 6, 7, 8, 9, 10, 11};
...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w2;
  ...
  casadi_copy((&w0), 1, (&w6));
  /* #169: @31 = mac(@6,@22,@31) */
  casadi_mtimes((&w6), casadi_s2, w22, casadi_s1, w31, casadi_s0, w, 0);
  /* #170: @31 = @31' */
  /* #171: @21 = zeros(1x3) */
  casadi_clear(w21, 3);
  /* #172: @0 = @0' */
  /* #173: @21 = mac(@0,@34,@21) */
  casadi_mtimes((&w0), casadi_s2, w34, casadi_s1, w21, casadi_s0, w, 0);
  /* #174: @21 = @21' */
  /* #175: @31 = (@31+@21) */
  ...
  /* #178: {@0, @6, @5, @4, @17, @39, @20, @2, @8, @12, @38, @36, @11} = vertsplit(@15) */
  w0 = w15[0];
  w6 = w15[1];
  w5 = w15[2];
  w4 = w15[3];
  ...
  /* #183: @43 = 00 */
  /* #184: @47 = 00 */
  /* #185: @10 = horzcat(@3, @42, @43, @47) */
  rr=(&w10);
  *rr++ = w3;
  /* #186: @10 = @10' */
  /* #187: @42 = 00 */
  /* #188: @13 = horzcat(@44, @3, @42, @45) */
  rr=(&w13);
  *rr++ = w3;
  /* #189: @13 = @13' */
  /* #190: @42 = 00 */
  /* #191: @37 = horzcat(@45, @46, @3, @42) */
  rr=(&w37);
  *rr++ = w3;
  /* #192: @37 = @37' */
  /* #193: @45 = 00 */
  /* #194: @7 = horzcat(@46, @45, @44, @3) */
  rr=(&w7);
  *rr++ = w3;
  /* #195: @7 = @7' */
  /* #196: @27 = horzcat(@10, @13, @37, @7) */
  rr=w27;
  *rr++ = w10;
  *rr++ = w13;
  *rr++ = w37;
  *rr++ = w7;
  ...
  /* #204: @29 = @28' */
  for (i=0, rr=w29, cs=w28; i<4; ++i) for (j=0; j<4; ++j) rr[i+j*4] = *cs++;
  /* #205: {@23, @26, @35, @27} = horzsplit(@29) */
  casadi_copy(w29, 4, w23);
  casadi_copy(w29+4, 4, w26);
  casadi_copy(w29+8, 4, w35);
  casadi_copy(w29+12, 4, w27);
  /* #206: @27 = @27' */
  /* #207: {@10, @13, @37, @7} = horzsplit(@27) */
  w10 = w27[0];
  w13 = w27[1];
  w37 = w27[2];
  w7 = w27[3];
  /* #208: @35 = @35' */
  /* #209: {@3, @18, @9, @14} = horzsplit(@35) */
  w3 = w35[0];
  w18 = w35[1];
  w9 = w35[2];
  w14 = w35[3];
  ...
  /* #229: @10 = (@10+@12) */
  w10 += w12;
  /* #230: @15 = vertcat(@0, @6, @5, @4, @17, @39, @7, @37, @3, @10, @38, @36, @11) */
  rr=w15;
  *rr++ = w0;
  *rr++ = w6;
  *rr++ = w5;
  ...
  *rr++ = w11;
  ...
  for (cii=casadi_s5, rr=w53, ss=w15; cii!=casadi_s5+9; ++cii) *rr++ = *cii>=0 ? ss[*cii] : 0;
  /* #232: (@40[0, 1, 2, 9, 10, 11, 12, 25, 26] = @53) */
  for (cii=casadi_s6, rr=w40, ss=w53; cii!=casadi_s6+9; ++cii, ++ss) if (*cii>=0) rr[*cii] = *ss;
  /* #233: @53 = @15[0, 1, 2, 6, 7, 8, 9, 10, 11] */
  for (cii=casadi_s5, rr=w53, ss=w15; cii!=casadi_s5+9; ++cii) *rr++ = *cii>=0 ? ss[*cii] : 0;
  /* #234: (@40[0, 3, 6, 9, 13, 17, 21, 25, 26] = @53) */
  for (cii=casadi_s7, rr=w40, ss=w53; cii!=casadi_s7+9; ++cii, ++ss) if (*cii>=0) rr[*cii] = *ss;
  /* #235: @15 = zeros(13x1) */
  casadi_clear(w15, 13);
  /* #236: @31 = zeros(1x3) */
  casadi_clear(w31, 3);
  ...
  casadi_fill(w32, 2, 1.);
  /* #238: {NULL, @0, NULL, NULL, NULL, NULL, NULL, @6, NULL, NULL, NULL, NULL, NULL} = vertsplit(@32) */
  w0 = w32[0];
  w6 = w32[1];
  /* #239: @5 = @0[0] */
  ...
  casadi_copy((&w5), 1, (&w0));
  /* #242: @31 = mac(@0,@22,@31) */
  casadi_mtimes((&w0), casadi_s8, w22, casadi_s1, w31, casadi_s0, w, 0);
  /* #243: @31 = @31' */
  /* #244: @21 = zeros(1x3) */
  casadi_clear(w21, 3);
  /* #245: @5 = @5' */
  /* #246: @21 = mac(@5,@34,@21) */
  casadi_mtimes((&w5), casadi_s8, w34, casadi_s1, w21, casadi_s0, w, 0);
  /* #247: @21 = @21' */
  /* #248: @31 = (@31+@21) */
  for (i=0, rr=w31, cs=w21; i<3; ++i) (*rr++) += (*cs++);
  /* #249: @31 = (-@31) */
  ...
  /* #250: (@15[:3] += @31) */
  for (rr=w15+0, ss=w31; rr!=w15+3; rr+=1) *rr += *ss++;
  /* #251: {@5, @0, @4, @17, @39, @7, @37, @3, @10, @38, @36, @11, @12} = vertsplit(@15) */
  w5 = w15[0];
  w0 = w15[1];
  w4 = w15[2];
  w17 = w15[3];
  ...
  /* #257: @45 = 00 */
  /* #258: @44 = 00 */
  /* #259: @48 = horzcat(@46, @52, @45, @44) */
  rr=(&w48);
  *rr++ = w52;
  /* #260: @48 = @48' */
  /* #261: @45 = 00 */
  /* #262: @44 = 00 */
  /* #263: @52 = horzcat(@6, @46, @45, @44) */
  rr=(&w52);
  *rr++ = w6;
  /* #264: @52 = @52' */
  /* #265: @45 = 00 */
  /* #266: @18 = (-@6) */
  w18 = (- w6 );
  /* #267: @8 = horzcat(@44, @45, @46, @18) */
  rr=(&w8);
  *rr++ = w18;
  /* #268: @8 = @8' */
  /* #269: @44 = 00 */
  /* #270: @18 = horzcat(@45, @44, @6, @46) */
  rr=(&w18);
  *rr++ = w6;
  /* #271: @18 = @18' */
  /* #272: @35 = horzcat(@48, @52, @8, @18) */
  rr=w35;
  *rr++ = w48;
  *rr++ = w52;
  *rr++ = w8;
  *rr++ = w18;
  /* #273: @27 = @35' */
  casadi_trans(w35,casadi_s9, w27, casadi_s9, iw);
  /* #274: @26 = mac(@27,@24,@26) */
  ...
  /* #305: @48 = (@48+@38) */
  w48 += w38;
  /* #306: @15 = vertcat(@5, @0, @4, @17, @39, @7, @18, @8, @6, @48, @36, @11, @12) */
  rr=w15;
  *rr++ = w5;
  *rr++ = w0;
  *rr++ = w4;
  ...
  *rr++ = w12;
  ...
  for (cii=casadi_s10, rr=w54, ss=w15; cii!=casadi_s10+7; ++cii) *rr++ = *cii>=0 ? ss[*cii] : 0;
  /* #308: (@40[3, 4, 5, 13, 14, 15, 16] = @54) */
  for (cii=casadi_s11, rr=w40, ss=w54; cii!=casadi_s11+7; ++cii, ++ss) if (*cii>=0) rr[*cii] = *ss;
  /* #309: @54 = @15[0, 1, 2, 6, 7, 8, 9] */
  for (cii=casadi_s10, rr=w54, ss=w15; cii!=casadi_s10+7; ++cii) *rr++ = *cii>=0 ? ss[*cii] : 0;
  /* #310: (@40[1, 4, 7, 10, 14, 18, 22] = @54) */
  for (cii=casadi_s12, rr=w40, ss=w54; cii!=casadi_s12+7; ++cii, ++ss) if (*cii>=0) rr[*cii] = *ss;
  /* #311: @15 = zeros(13x1) */
  casadi_clear(w15, 13);
  /* #312: @31 = zeros(1x3) */
  casadi_clear(w31, 3);
  ...
  casadi_fill(w32, 2, 1.);
  /* #314: {NULL, NULL, @5, NULL, NULL, NULL, NULL, NULL, @0, NULL, NULL, NULL, NULL} = vertsplit(@32) */
  w5 = w32[0];
  w0 = w32[1];
  /* #315: @4 = @5[0] */
  ...
  /* #321: @4 = @4' */
  /* #322: @21 = mac(@4,@34,@21) */
  casadi_mtimes((&w4), casadi_s13, w34, casadi_s1, w21, casadi_s0, w, 0);
  /* #323: @21 = @21' */
  /* #324: @31 = (@31+@21) */
  for (i=0, rr=w31, cs=w21; i<3; ++i) (*rr++) += (*cs++);
  /* #325: @31 = (-@31) */
  ...
  /* #326: (@15[:3] += @31) */
  for (rr=w15+0, ss=w31; rr!=w15+3; rr+=1) *rr += *ss++;
  /* #327: {@4, @5, @17, @39, @7, @18, @8, @6, @48, @36, @11, @12, @38} = vertsplit(@15) */
  w4 = w15[0];
  w5 = w15[1];
  w17 = w15[2];
  w39 = w15[3];
  ...
  w19 = (- w0 );
  /* #334: @46 = 00 */
  /* #335: @50 = horzcat(@45, @44, @19, @46) */
  rr=(&w50);
  *rr++ = w19;
  /* #336: @50 = @50' */
  /* #337: @44 = 00 */
  /* #338: @46 = 00 */
  /* #339: @19 = horzcat(@44, @45, @46, @0) */
  rr=(&w19);
  *rr++ = w0;
  /* #340: @19 = @19' */
  /* #341: @46 = 00 */
  /* #342: @42 = 00 */
  /* #343: @51 = horzcat(@0, @46, @45, @42) */
  rr=(&w51);
  *rr++ = w0;
  /* #344: @51 = @51' */
  /* #345: @0 = (-@0) */
  w0 = (- w0 );
  /* #346: @10 = horzcat(@46, @0, @44, @45) */
  rr=(&w10);
  *rr++ = w0;
  /* #347: @10 = @10' */
  /* #348: @27 = horzcat(@50, @19, @51, @10) */
  rr=w27;
  *rr++ = w50;
  *rr++ = w19;
  *rr++ = w51;
  *rr++ = w10;
  /* #349: @35 = @27' */
  casadi_trans(w27,casadi_s14, w35, casadi_s14, iw);
  /* #350: @26 = mac(@35,@24,@26) */
  casadi_mtimes(w35, casadi_s14, w24, casadi_s4, w26, casadi_s4, w, 0);
  /* #351: @31 = @26[1:4] */
  for (rr=w31, ss=w26+1; ss!=w26+4; ss+=1) *rr++ = *ss;
  /* #352: (@23[1:4] += @31) */
  for (rr=w23+1, ss=w31; rr!=w23+4; rr+=1) *rr += *ss++;
  ...
  /* #356: @29 = @28' */
  for (i=0, rr=w29, cs=w28; i<4; ++i) for (j=0; j<4; ++j) rr[i+j*4] = *cs++;
  /* #357: {@23, @26, @35, @27} = horzsplit(@29) */
  casadi_copy(w29, 4, w23);
  casadi_copy(w29+4, 4, w26);
  casadi_copy(w29+8, 4, w35);
  casadi_copy(w29+12, 4, w27);
  /* #358: @27 = @27' */
  /* #359: {@50, @19, @51, @10} = horzsplit(@27) */
  w50 = w27[0];
  w19 = w27[1];
  w51 = w27[2];
  w10 = w27[3];
  /* #360: @35 = @35' */
  /* #361: {@0, @20, @9, @52} = horzsplit(@35) */
  w0 = w35[0];
  w20 = w35[1];
  w9 = w35[2];
  w52 = w35[3];
  ...
  /* #381: @50 = (@50+@36) */
  w50 += w36;
  /* #382: @15 = vertcat(@4, @5, @17, @39, @7, @18, @10, @51, @0, @50, @11, @12, @38) */
  rr=w15;
  *rr++ = w4;
  *rr++ = w5;
  *rr++ = w17;
  ...
  *rr++ = w38;
  ...
  for (cii=casadi_s15, rr=w40, ss=w54; cii!=casadi_s15+7; ++cii, ++ss) if (*cii>=0) rr[*cii] = *ss;
  /* #385: @54 = @15[0, 1, 2, 6, 7, 8, 9] */
  for (cii=casadi_s10, rr=w54, ss=w15; cii!=casadi_s10+7; ++cii) *rr++ = *cii>=0 ? ss[*cii] : 0;
  /* #386: (@40[2, 5, 8, 11, 15, 19, 23] = @54) */
  for (cii=casadi_s16, rr=w40, ss=w54; cii!=casadi_s16+7; ++cii, ++ss) if (*cii>=0) rr[*cii] = *ss;
  /* #387: @46 = 00 */
  /* #388: @44 = 00 */
  /* #389: @45 = 00 */
  /* #390: @42 = 00 */
  ...
  /* #399: @4 = ones(13x1,1nz) */
  w4 = 1.;
  /* #400: {NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @5, NULL, NULL, NULL} = vertsplit(@4) */
  w5 = w4;
  /* #401: @4 = (-@5) */
  w4 = (- w5 );
  /* #402: @17 = horzcat(@55, @56, @57, @4) */
  rr=(&w17);
  *rr++ = w4;
  /* #403: @17 = @17' */
  /* #404: @56 = 00 */
  ...
  w4 = (- w5 );
  /* #406: @57 = 00 */
  /* #407: @39 = horzcat(@56, @55, @4, @57) */
  rr=(&w39);
  *rr++ = w4;
  /* #408: @39 = @39' */
  /* #409: @58 = 00 */
  /* #410: @4 = horzcat(@57, @5, @55, @58) */
  rr=(&w4);
  *rr++ = w5;
  /* #411: @4 = @4' */
  /* #412: @57 = 00 */
  /* #413: @7 = horzcat(@5, @57, @56, @55) */
  rr=(&w7);
  *rr++ = w5;
  /* #414: @7 = @7' */
  /* #415: @35 = horzcat(@17, @39, @4, @7) */
  rr=w35;
  *rr++ = w17;
  *rr++ = w39;
  *rr++ = w4;
  *rr++ = w7;
  /* #416: @27 = @35' */
  casadi_trans(w35,casadi_s17, w27, casadi_s17, iw);
  /* #417: @26 = mac(@27,@24,@26) */
  casadi_mtimes(w27, casadi_s17, w24, casadi_s4, w26, casadi_s4, w, 0);
  /* #418: @31 = @26[1:4] */
  for (rr=w31, ss=w26+1; ss!=w26+4; ss+=1) *rr++ = *ss;
  /* #419: (@23[1:4] += @31) */
  for (rr=w23+1, ss=w31; rr!=w23+4; rr+=1) *rr += *ss++;
  ...
  /* #423: @28 = @29' */
  for (i=0, rr=w28, cs=w29; i<4; ++i) for (j=0; j<4; ++j) rr[i+j*4] = *cs++;
  /* #424: {@23, @25, @26, @27} = horzsplit(@28) */
  casadi_copy(w28, 4, w23);
  casadi_copy(w28+4, 4, w25);
  casadi_copy(w28+8, 4, w26);
  casadi_copy(w28+12, 4, w27);
  /* #425: @27 = @27' */
  /* #426: {@17, @39, @4, @7} = horzsplit(@27) */
  w17 = w27[0];
  w39 = w27[1];
  w4 = w27[2];
  w7 = w27[3];
  /* #427: @26 = @26' */
  /* #428: {@5, @18, @10, @51} = horzsplit(@26) */
  w5 = w26[0];
  w18 = w26[1];
  w10 = w26[2];
  w51 = w26[3];
  ...
  /* #446: @56 = 00 */
  /* #447: @55 = 00 */
  /* #448: @23 = vertcat(@46, @44, @45, @42, @43, @47, @7, @4, @5, @17, @57, @56, @55) */
  rr=w23;
  *rr++ = w7;
  *rr++ = w4;
  *rr++ = w5;
  *rr++ = w17;
  ...
  /* #453: @59 = @40' */
  casadi_trans(w40,casadi_s18, w59, casadi_s18, iw);
  /* #454: output[2][0] = @59 */
