...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real w0, *w1=w+11, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, *w19=w+31, *w20=w+48, *w21=w+51, *w22=w+64, *w23=w+67, *w24=w+76, *w25=w+80, *w26=w+84, *w27=w+88, *w28=w+92, *w29=w+96, *w30=w+112, *w31=w+128, *w32=w+131, *w33=w+134, w35, w36, w37;
  /* #0: @0 = 0 */
  w0 = 0.;
  /* #1: @1 = zeros(1x3) */
  casadi_clear(w1, 3);
  ...
  *rr++ = w11;
  ...
  /* #106: @25 = @25' */
  /* #107: @30 = mac(@27,@25,@30) */
  for (i=0, rr=w30; i<4; ++i) for (j=0; j<4; ++j, ++rr) for (k=0, ss=w27+j, tt=w25+i*1; k<1; ++k) *rr += ss[k*4]**tt++;
  /* #108: @29 = @30' */
  for (i=0, rr=w29, cs=w30; i<4; ++i) for (j=0; j<4; ++j) rr[i+j*4] = *cs++;
  /* #109: {@27, @25, @24, @26} = horzsplit(@29) */
  casadi_copy(w29, 4, w27);
  casadi_copy(w29+4, 4, w25);
  casadi_copy(w29+8, 4, w24);
  casadi_copy(w29+12, 4, w26);
  /* #110: @26 = @26' */
  /* #111: {@11, @10, @9, @8} = horzsplit(@26) */
  w11 = w26[0];
  w10 = w26[1];
  w9 = w26[2];
  w8 = w26[3];
  /* #112: @24 = @24' */
  /* #113: {@2, @0, @6, @7} = horzsplit(@24) */
  w2 = w24[0];
  w0 = w24[1];
  w6 = w24[2];
  w7 = w24[3];
