...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real *w0=w+4, *w1=w+17, *w2=w+20, w3, *w4=w+30, *w5=w+39, *w6=w+42, *w7=w+45, *w8=w+54, *w9=w+63, *w10=w+76, *w11=w+79, *w12=w+82, *w13=w+86, w14, w15, w16, w17, w18, w19, w20, w21, w22, w23, w24, w25, *w26=w+101, *w27=w+105, w28, *w29=w+110, *w30=w+114, *w31=w+118, *w32=w+122, *w33=w+126, w34, w35, *w36=w+144, *w37=w+153, *w38=w+162, w39, w40, w41, w42, w43, *w44=w+176;
  /* #0: @0 = zeros(13x1) */
  casadi_clear(w0, 13);
  /* #1: @1 = zeros(3x1) */
  casadi_clear(w1, 3);
  ...
  *rr++ = w3;
  ...
  casadi_clear(w36, 9);
  /* #118: @37 = (2.*@4) */
  for (i=0, rr=w37, cs=w4; i<9; ++i) *rr++ = (2.* *cs++ );
  /* #119: @38 = @37' */
  for (i=0, rr=w38, cs=w37; i<3; ++i) for (j=0; j<3; ++j) rr[i+j*3] = *cs++;
  /* #120: @36 = mac(@38,@8,@36) */
  for (i=0, rr=w36; i<3; ++i) for (j=0; j<3; ++j, ++rr) for (k=0, ss=w38+j, tt=w8+i*3; k<3; ++k) *rr += ss[k*3]**tt++;
  /* #121: @7 = (@7+@36) */
  ...
  /* #124: @36 = mac(@8,@38,@36) */
  for (i=0, rr=w36; i<3; ++i) for (j=0; j<3; ++j, ++rr) for (k=0, ss=w8+j, tt=w38+i*3; k<3; ++k) *rr += ss[k*3]**tt++;
  /* #125: @36 = (2.*@36) */
  ...
  /* #162: {@25, @19, @28, @34, @35, @17, @18, @3, @39, @40, @41, @42, @43} = vertsplit(@0) */
  w25 = w0[0];
  w19 = w0[1];
  w28 = w0[2];
  w34 = w0[3];
  ...
  /* #198: @44 = @33' */
  for (i=0, rr=w44, cs=w33; i<4; ++i) for (j=0; j<4; ++j) rr[i+j*4] = *cs++;
  /* #199: {@29, @30, @12, @26} = horzsplit(@44) */
  casadi_copy(w44, 4, w29);
  casadi_copy(w44+4, 4, w30);
  casadi_copy(w44+8, 4, w12);
  casadi_copy(w44+12, 4, w26);
  /* #200: @26 = @26' */
  /* #201: {@39, @23, @3, NULL} = horzsplit(@26) */
  w39 = w26[0];
  w23 = w26[1];
  w3 = w26[2];
  /* #202: @24 = (@24-@3) */
  ...
  w24 += w18;
  /* #206: @30 = @30' */
  /* #207: {@18, NULL, @20, @35} = horzsplit(@30) */
  w18 = w30[0];
  w20 = w30[2];
  w35 = w30[3];
  /* #208: @24 = (@24+@18) */
  w24 += w18;
  /* #209: @29 = @29' */
  /* #210: {NULL, @18, @34, @28} = horzsplit(@29) */
  w18 = w29[1];
  w34 = w29[2];
  w28 = w29[3];
  /* #211: @24 = (@24-@18) */
  ...
  casadi_clear(w7, 9);
  /* #239: @7 = mac(@37,@4,@7) */
  for (i=0, rr=w7; i<3; ++i) for (j=0; j<3; ++j, ++rr) for (k=0, ss=w37+j, tt=w4+i*3; k<3; ++k) *rr += ss[k*3]**tt++;
  /* #240: @2 = (@2+@7) */
