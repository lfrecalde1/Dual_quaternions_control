...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  casadi_real w0, w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, *w13=w+17, *w14=w+30, *w15=w+33, *w16=w+42, *w17=w+51, *w18=w+60, *w19=w+64, *w20=w+68, *w21=w+77, *w22=w+80, *w23=w+84, *w24=w+88, *w25=w+92, *w26=w+96, *w27=w+112, *w28=w+128, *w29=w+131;
  /* #0: @0 = input[0][0] */
  w0 = arg[0] ? arg[0][0] : 0;
  /* #1: @1 = input[0][1] */
  w1 = arg[0] ? arg[0][1] : 0;
  ...
  *rr++ = w12;
  ...
  w1 = 1.;
  /* #48: (@21[2] = @1) */
  for (rr=w21+2, ss=(&w1); rr!=w21+3; rr+=1) *rr = *ss++;
  /* #49: @14 = mac(@15,@21,@14) */
  ...
  *rr++ = w3;
  ...
  /* #77: @19 = mac(@27,@18,@19) */
  for (i=0, rr=w19; i<1; ++i) for (j=0; j<4; ++j, ++rr) for (k=0, ss=w27+j, tt=w18+i*4; k<4; ++k) *rr += ss[k*4]**tt++;
  /* #78: @19 = (@1*@19) */
  ...
  *rr++ = w9;
  /* #106: @21 = @19[1:4] */
  for (rr=w21, ss=w19+1; ss!=w19+4; ss+=1) *rr++ = *ss;
  /* #107: @28 = zeros(3x1) */
  casadi_clear(w28, 3);
  /* #108: @29 = @13[10:13] */
  for (rr=w29, ss=w13+10; ss!=w13+13; ss+=1) *rr++ = *ss;
  /* #109: @28 = mac(@17,@29,@28) */
  for (i=0, rr=w28; i<1; ++i) for (j=0; j<3; ++j, ++rr) for (k=0, ss=w17+j, tt=w29+i*3; k<3; ++k) *rr += ss[k*3]**tt++;
  /* #110: @0 = @28[2] */
