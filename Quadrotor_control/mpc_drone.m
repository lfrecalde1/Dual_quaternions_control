...
for k = 1:N
    ...
    q_error = quaternion_multiply(q, q_d_c);
    [angle, axis] = quaternionToAxisAngle(q_error');
    obj_quat = obj_quat + (1-q_error(1)) + q_error(2:4)'*q_error(2:4);
...
%% FINAL COST
obj = obj_he + 0.005*obj_u + 0.005*obj_quat;
